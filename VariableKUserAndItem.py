...
#
# plt.figure(figsize=(10,6))
# plt.plot(range(1,20),Item_VarK_a, color = 'red',linestyle = 'dashed', marker = 'o', markerfacecolor='red',markersize=10)
# plt.plot(range(1,20),Item_VarK_b, color = 'blue',linestyle = 'dashed', marker = '*', markerfacecolor='blue',markersize=10)
#
# plt.title('Error Rate vs. Value of K for Item Based Collaborative Filtering Algorithm')
# plt.xlabel('Value of K')
# plt.ylabel('Error Rate')
